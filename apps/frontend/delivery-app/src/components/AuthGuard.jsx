...
export default function AuthGuard({ children }) {
    ...
    useEffect(() => {
        if (!loading) {
            // Si on est sur une route publique et qu'on est déjà connecté, on redirige vers les commandes disponibles
    ...
    }, [accessToken, loading, pathname, isPublicRoute, router])
